...
function Partners() {
    return (
        <Container fluid="md" className="py-5 d-flex flex-column align-items-center justify-content-center text-center" id = "our_partners">
            ...
            <Row className='my-4'>
                <Col md={4}>
                    <Link href="/"><Image src={Johnson_and_johnson} className="img-fluid" alt="Johnson and Johnson logo"/></Link>
                </Col>
                <Col md={4}>
                    <Link href="/"><Image src={Pfizer} className="img-fluid" alt="Pfizer logo"/></Link>
                </Col>
                <Col md={4}>
                    <Link href="/"><Image src={Astrazeneca} className="img-fluid" alt="Pfizer-logo logo"/></Link>
                </Col>
            </Row>
            <Row>
                <Col md={4}>
                    <Link href="/"><Image src={Biogen} className="img-fluid" alt="Biogen logo" /></Link>
                </Col>
                <Col md={4}>
                    <Link href="/"><Image src={Stryker} className="img-fluid" alt="Stryker logo" /></Link>
                </Col>
                <Col md={4}>
                    <Link href="/"><Image src={Cipla} className="img-fluid" alt="Cipla logo" /></Link>
                </Col>
            </Row>
        </Container>
    )
